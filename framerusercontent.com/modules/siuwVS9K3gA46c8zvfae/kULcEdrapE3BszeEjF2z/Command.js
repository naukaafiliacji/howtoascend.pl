...
var Command_default = (React) => {
  if (!Component) {
    ...
    const Command = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
